        ...
        <table className="w-full text-left text-sm table-auto">
          <thead className="bg-basic border-b font-montserrat text-sm border-text/20">
            <tr>
              ...
              <th className="py-3.5 px-6 text-text/80  font-semibold uppercase tracking-wider w-60 min-w-[250px]">
                Customer
              </th>
              <th className="py-3.5 px-6 text-text/80  font-semibold uppercase tracking-wider w-32 min-w-[120px]">
                Amount
              </th>
              <th className="py-3.5 px-6 text-center text-text/80  font-semibold uppercase tracking-wider w-16 min-w-[60px]">
                Qty
              </th>
              <th className="py-3.5 px-6 text-text/80  font-semibold uppercase tracking-wider w-24 min-w-[100px]">
                Status
              </th>
              <th className="py-3.5 px-6 text-text/80  font-semibold uppercase tracking-wider w-40 min-w-40">
                Due Date
              </th>
              <th className="py-3.5 px-6 text-right text-text/80  font-semibold uppercase tracking-wider w-20 min-w-20">
                Actions
              </th>
            </tr>
          </thead>
                    ...
                    <button
                      ...
                      className={`p-2 rounded-md transition-all cursor-pointer ${
                        openMenuId === inv.id
                          ...
                          : "text-slate-400 hover:text-text/70 hover:bg-slate-100"
                      }`}
